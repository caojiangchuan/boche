...
const {NoticesForm} = new SystemManageForm();

const Utils = new Common();
const confirm = Modal.confirm;
const FormItem = Form.Item;

@connect(({ noticesManage, loading }) => ({
  noticesManage,
  loading: loading.models.noticesManage,
}))
@Form.create()
  ...
  render() {
    ...
    return (
      <PageHeaderLayout>
        ...
        <NoticesForm {...parentMethods} modalVisible={modalVisible} formType={formType} selectedRows={selectedRows} />
      </PageHeaderLayout>
    );
  }
}
