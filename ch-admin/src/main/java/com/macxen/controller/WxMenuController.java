...
public class WxMenuController {
    ...
    public String menuCreateSample(@PathVariable String appid) throws WxErrorException, MalformedURLException {
        ...
        button1.setName("我要停车");
        button1.setUrl("http://fhx.zendaimoney.com/map");

        WxMenuButton button2 = new WxMenuButton();
        button2.setType(MenuButtonType.VIEW);
        button2.setName("自助结费");
        button2.setUrl("http://fhx.zendaimoney.com/self");

        WxMenuButton button3 = new WxMenuButton();
        button3.setName("个人中心");
        button3.setType(MenuButtonType.VIEW);
        button3.setUrl("http://fhx.zendaimoney.com/person");
        ...
        if (servletRequestAttributes != null) {
            ...
            String url = WxMpConfiguration.getMpServices().get(appid)
                .oauth2buildAuthorizationUrl(
                    String.format(domainName + "wx/map", requestURL.getProtocol(), requestURL.getHost(), appid),
                    WxConsts.OAuth2Scope.SNSAPI_BASE, "map");
            button1.setUrl(url);
            String url1 = WxMpConfiguration.getMpServices().get(appid)
                    .oauth2buildAuthorizationUrl(
                        String.format(domainName + "wx/self", requestURL.getProtocol(), requestURL.getHost(), appid),
                        WxConsts.OAuth2Scope.SNSAPI_BASE, "self");
            button2.setUrl(url1);
            
            String url2 = WxMpConfiguration.getMpServices().get(appid)
                    .oauth2buildAuthorizationUrl(
                        String.format(domainName + "wx/person", requestURL.getProtocol(), requestURL.getHost(), appid),
                        WxConsts.OAuth2Scope.SNSAPI_USERINFO, "person");
            button3.setUrl(url2);
...
//        button31.setName("车辆管理");
//        button31.setUrl("http://fhx.zendaimoney.com/carMenu");
//
//        WxMenuButton button32 = new WxMenuButton();
//        button32.setType(MenuButtonType.VIEW);
//        button32.setName("订单管理");
//        button32.setUrl("http://fhx.zendaimoney.com/order");
//
//        WxMenuButton button33 = new WxMenuButton();
//        button33.setType(MenuButtonType.VIEW);
//        button33.setName("意见反馈");
//        button33.setUrl("http://fhx.zendaimoney.com/view");
